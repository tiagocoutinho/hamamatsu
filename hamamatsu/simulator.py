...
AppInfo = collections.namedtuple('AppInfo', ('type', 'date', 'version',
                                             'directory', 'title', 'titlelong',
                                             'progdatadir'))


DefaultAppInfo = AppInfo('HiPic', str(datetime.date.today()), '8.3.0 pf8',
                         'C:\\ProgramData\\Hamamatsu\\HiPic\\',
                         'HiPic Emulator', 'Bliss HiPic Emulator',
